...
public class MarkovTextGenerator {
    public static final String CORPUS_FILE = "data/fullseuss.txt";
    public static final int NUMBER_OF_TEXTS_TO_GENERATE = 20;
    ...
    public static void main(String[] args) throws IOException {
        ...
        NGramMap t1 = new NGramMap(reader, 1,
                MarkovTextGenerator::newOuterTrieMap,
                MarkovTextGenerator::newInnerTrieMap
        );
