 ...
 *  Compilation:  javac edu.caltech.cs2.lab09.libraries.StdDraw.java
 *  Execution:    java edu.caltech.cs2.lab09.libraries.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code edu.caltech.cs2.lab09.libraries.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code edu.caltech.cs2.lab09.libraries.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">edu.caltech.cs2.lab09.libraries.StdDraw.java</a>
 ...
 *           edu.caltech.cs2.lab09.libraries.StdDraw.setPenRadius(0.05);
 *           edu.caltech.cs2.lab09.libraries.StdDraw.setPenColor(edu.caltech.cs2.lab09.libraries.StdDraw.BLUE);
 *           edu.caltech.cs2.lab09.libraries.StdDraw.point(0.5, 0.5);
 *           edu.caltech.cs2.lab09.libraries.StdDraw.setPenColor(edu.caltech.cs2.lab09.libraries.StdDraw.MAGENTA);
 *           edu.caltech.cs2.lab09.libraries.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code edu.caltech.cs2.lab09.libraries.StdDraw.line()} and {@code edu.caltech.cs2.lab09.libraries.StdDraw.point()}
 *  draw lines and points; the methods {@code edu.caltech.cs2.lab09.libraries.StdDraw.setPenRadius()}
 *  and {@code edu.caltech.cs2.lab09.libraries.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code edu.caltech.cs2.lab09.libraries.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   edu.caltech.cs2.lab09.libraries.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code edu.caltech.cs2.lab09.libraries.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code edu.caltech.cs2.lab09.libraries.StdDraw.setPenColor(edu.caltech.cs2.lab09.libraries.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code edu.caltech.cs2.lab09.libraries.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code edu.caltech.cs2.lab09.libraries.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   edu.caltech.cs2.lab09.libraries.StdDraw.setFont(font);
 *   edu.caltech.cs2.lab09.libraries.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code edu.caltech.cs2.lab09.libraries.StdDraw.clear(edu.caltech.cs2.lab09.libraries.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   edu.caltech.cs2.lab09.libraries.StdDraw.setScale(-2, +2);
 *   edu.caltech.cs2.lab09.libraries.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       edu.caltech.cs2.lab09.libraries.StdDraw.clear();
 *       edu.caltech.cs2.lab09.libraries.StdDraw.filledCircle(x, y, 0.05);
 *       edu.caltech.cs2.lab09.libraries.StdDraw.filledCircle(-x, -y, 0.05);
 *       edu.caltech.cs2.lab09.libraries.StdDraw.show();
 *       edu.caltech.cs2.lab09.libraries.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
   ...
   * {@code edu.caltech.cs2.lab09.libraries.StdDraw.BLACK}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.BLUE}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.CYAN},
   * {@code edu.caltech.cs2.lab09.libraries.StdDraw.DARK_GRAY}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.GRAY}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.GREEN},
   * {@code edu.caltech.cs2.lab09.libraries.StdDraw.LIGHT_GRAY}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.MAGENTA}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.ORANGE},
   * {@code edu.caltech.cs2.lab09.libraries.StdDraw.PINK}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.RED}, {@code edu.caltech.cs2.lab09.libraries.StdDraw.WHITE}, and
   * {@code edu.caltech.cs2.lab09.libraries.StdDraw.YELLOW}.
   *
  ...
  private static Image getImage(String filename) {
    ...
    // in case file is inside a .jar (classpath relative to edu.caltech.cs2.lab09.libraries.StdDraw)
    if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to edu.caltech.cs2.lab09.libraries.StdDraw)
        try {
            URL url = edu.caltech.cs2.lab09.libraries.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
...
*/
  ...
  /***
   * Returns the image displayed by {@code edu.caltech.cs2.lab09.libraries.StdDraw}.
